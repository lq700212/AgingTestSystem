...
namespace AgingTestSystem.Services
{
    ...
    ///   行为与 HJVision 现场一字不差（工具侧粘贴什么算什么，不受影响）。
    ...
    {
        /// <summary>激活文件名（住程序目录，跟机器；与 HJVision 同名）。</summary>
        public const string IniFileName = "MainSetting.ini";

        /// <summary>ini 段名（与 HJVision 一致）。</summary>
        public const string Section = "RunHash";

        /// <summary>设备绑定键（= Encrypt(设备ID + "A")，出厂手写）。</summary>
        ...
        /// <summary>
        /// 加密（与 HJVision MainForm.Encrypt / 获取激活码 Form1.Encrypt 逐字节一致）。
        ...
        /// <summary>设备ID码 = Encrypt(设备ID + "A")（出厂写 RunHash1 的值，工具 textBox1→textBox2 同款）。</summary>
        ...
        /// <summary>
        /// 找计数格（与 HJVision HashTimer_Tick / HuaJi_Button_Click 的 for (i &lt; 840)
