...
| PanelLayoutConfig | 默认布局基准坐标（V1.91 紧凑 204×128、V1.95 加高 204×140：按钮149,97,46,36/第一行四件套同行/标签列65/SN宽121/压力宽121右缘同界；V1.92：下电74,4,49宽左缘对齐SN＋右缘贴真空4px/真空127,4,54/选中框185,6,14；V1.94：选中框181,4,18/真空123,4,54/下电74,4,45宽；V1.95：压力28隙6/电流48隙4/SN52隙4/配方77/延时98/烧屏116/交接缝9/行选按钮高139）、ResolveAnchors 幂等零漂移、高度+10 下链跟随+上链锁定+交接缝吸收（V1.77：SN/压力定高位现52/28）、宽度+10 右锚定组随动（下电左缘跟SN宽45）、颜色解析钳位/回退、双实例解析零差异＋无文件口存在性锁（V1.91 删 PanelLayout.json 存取）、电流行几何（V1.77：缺省关/有效高156行高164/电流行74,48,121,16/SN68配方93按钮113/压力28不动/标签48/SN标签68/开关往返零漂移）、工作状态块删除（V1.88.16：真空块上第一行4当基准/下电跟随/删除三处无残留锁） |
