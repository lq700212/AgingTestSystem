...
| PanelLayoutConfig | 默认布局基准坐标（V1.91 紧凑 204×128：按钮149,85,46,36/第一行四件套同行/标签列65/SN宽121/压力宽121右缘同界；V1.92：下电74,4,49宽左缘对齐SN＋右缘贴真空4px/真空127,4,54/选中框185,6,14）、ResolveAnchors 幂等零漂移、高度+10 下链跟随+上链锁定+交接缝吸收（V1.77：SN/压力定高位现46/26）、宽度+10 右锚定组随动（下电左缘跟SN宽49）、颜色解析钳位/回退、双实例解析零差异＋无文件口存在性锁（V1.91 删 PanelLayout.json 存取）、电流行几何（V1.77：缺省关/有效高144行高152/电流行74,44,121,16/SN62配方81按钮101/压力26不动/标签44/SN标签62/开关往返零漂移）、工作状态块删除（V1.88.16：真空块上第一行4当基准/下电跟随/删除三处无残留锁） |
