...
$Map = @(
    ...
    @{ Pat = @("*BatchRecipeForm*", "*StationSettingsForm*", "*RecipeManagerForm*"); Mods = @("UiPureHelpers", "LegacyRecipeGuard", "RecipeStorage", "UiFinalizerV172_14") },
    ...
    @{ Pat = @("*UnloadJudgeForm*");                Mods = @("PolicyV167", "DeviceManagerPolicy", "UiFinalizerV172_14") },
    ...
    @{ Pat = @("*FlowCockpitForm*", "*FlowGraph*"); Mods = @("FlowCockpitV170", "PolicyV167", "UiFinalizerV172_14") },
    @{ Pat = @("*MainForm*");                       Mods = @("UiPureHelpers", "UiStyleV172_1", "ThemeManager", "SettingsValidate", "UiFinalizerV172_14") },
