...
>
> **72 站自适应（V1.88.22 双模式，默认按宽顶满大字版，列数保持 8×9 不动）**：中间工位区多宽、
> 面板就等比缩放到顶满宽度（无横向条，高超出部分纵向滚动、只上下滑动；字大，面板不变形；
> 小到 4pt 不再小（V1.88.21：1280×1024小屏跟随缩小不挤叠）；显示区被挤到极小才出滚动条兜底，站一个不少）。
> "关于"下拉可切回 FillScreen 双向精确铺满一屏（无滚动条，但字小）。
