<#
.SYNOPSIS
  老化测试系统工控机一键激活（与 HJVision 同源同口径，与 tools/auto_activate.py 同逻辑）。
.DESCRIPTION
...
# ---------------- 主流程 ----------------
Write-Host "============================================================"
Write-Host "老化测试系统 一键激活（与软件内【关于→软件授权】同口径）"
Write-Host "============================================================"
...
Write-Host "------------------------------------------------------------"
Write-Host "[成功] 已激活（$statusText）。请重启老化测试系统，【关于→软件授权】应显示“$statusText”。"
